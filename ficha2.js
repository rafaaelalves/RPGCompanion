...
// console.log(piloto.geral)
// console.log('------- Piloto fim -------')
...
mech.reacoes.percepcaopassiva = mech.atributos.sabedoria + piloto.geral.proficiencia,
...
//console.log(mech.geral)

apTotal = 0
for (let i in mech.componentes){
    if (ap in mech.componentes[i]){
        apTotal += mech.componentes[i].ap
        console.log.log(apTotal)
    }
}